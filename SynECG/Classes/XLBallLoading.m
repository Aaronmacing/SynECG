...
-(void)initUI{
    ...
    _ballContainer.frame = CGRectMake(0, 0, 140, 140);
    ...
    _labelP  = [[UILabel alloc]initWithFrame:CGRectMake(0, 120, 140, 20)];
    _labelP.text = @"补偿数据中...";
    _labelP.textColor = [UIColor lightGrayColor];
    _labelP.textAlignment = NSTextAlignmentCenter;
    _labelP.font = [UIFont systemFontOfSize:13];
    [_ballContainer.contentView addSubview:_labelP];
    ...
    _ball1.backgroundColor = [UIColor colorWithRed:0 green:217/255.f blue:196/255.f alpha:1];
    ...
    _ball2.backgroundColor = [UIColor colorWithRed:0 green:217/255.f blue:196/255.f alpha:1];
    ...
    _ball3.backgroundColor = [UIColor colorWithRed:0 green:217/255.f blue:196/255.f alpha:1];
...
-(void)animationDidStart:(CAAnimation *)anim{
    ...
    [UIView animateWithDuration:duration delay:delay options:UIViewAnimationOptionCurveEaseOut| UIViewAnimationOptionBeginFromCurrentState animations:^{
        self->_ball1.transform = CGAffineTransformMakeScale(ballScale, ballScale);
        self->_ball2.transform = CGAffineTransformMakeScale(ballScale, ballScale);
        self->_ball3.transform = CGAffineTransformMakeScale(ballScale, ballScale);
        ...
        [UIView animateWithDuration:duration delay:delay options:UIViewAnimationOptionCurveEaseInOut| UIViewAnimationOptionBeginFromCurrentState animations:^{
            self->_ball1.transform = CGAffineTransformIdentity;
            self->_ball2.transform = CGAffineTransformIdentity;
            self->_ball3.transform = CGAffineTransformIdentity;
        } completion:nil];
    }];
}
